---
title: "Serverless Shiny application with Github page"
include-in-header: 
  text: |
    <script type="application/javascript" src="coi-serviceworker.min.js"></script>
    <script type="application/javascript" src="enable-threads.js"></script>
---

See [this blog](https://r-posts.com/build-serverless-shiny-application-via-github-page/) to learn how to host such a Shiny app.
...
<script type="module">
  ...
  const webR = new WebR();
  // TODO
  const shinyScriptURL = 'https://gist.githubusercontent.com/stla/b77c4dcbe3cf3b0daef88baa69f4e097/raw/38eac7e1ac6ebf2daa95e2c7e09af987b40b5692/asynchronousShinyApp.R'
  const shinyScriptName = 'asynchronousShinyApp.R'
  ...
  const loadShiny = async () => {
    try {
      ...
      // TODO
      const registration = await navigator.serviceWorker.register('/shinyGP01/httpuv-serviceworker.js', { scope: '/shinyGP01/' }).catch((error) => {
      ...
      document.getElementById('statusButton').innerHTML = `
        ...
        Installing packages...
      `;
      await webR.installPackages(["shiny", "jsonlite", "DT", "plotly", "chron", "callr", "promises", "future"])
