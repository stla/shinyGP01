...
<script type="module">
  ...
  const webR = new WebR();
  // TODO
  const shinyScriptURL = 'https://gist.githubusercontent.com/stla/b77c4dcbe3cf3b0daef88baa69f4e097/raw/38eac7e1ac6ebf2daa95e2c7e09af987b40b5692/asynchronousShinyApp_callr.R'
  const shinyScriptName = 'asynchronousShinyApp_callr.R'
  ...
  const loadShiny = async () => {
    try {
      ...
      document.getElementById('statusButton').innerHTML = `
        ...
        Installing packages...
      `;
      await webR.installPackages(["shiny", "jsonlite", "DT", "plotly", "chron", "callr", "ps"])
